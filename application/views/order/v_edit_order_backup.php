<div class="main-panel">
										...
										<div class="form-group form-floating-label">
											...
											<select class="form-control" id="version"
												...
												<option value="">--Select Version--</option>
													...
													<?php if($ver['id'] == $byId['id_ver']){ ?>
														<option value="<?= $ver['id']; ?>" selected> <?=  $ver['version_name']; ?>
													<?php }else{ ?>
														<option value="<?= $ver['id']; ?>"> <?=  $ver['version_name']; ?>
													<?php } ?>
												<?php } ?>
												<label for="selectFloatingLabel"
	...
	<script>
		$(document).ready(function () {
			...
			$.ajax({
				type: "GET",
				url: "<?= base_url('OrderRecord/editData/') ?>" + id_ord + "/edit",
				data: {
					id_ord: id_ord
				},
				dataType: "JSON",
