...
<head>
	...
	<title>BRKS | Sofware Order Confirmation</title>
	<meta content='width=device-width, initial-scale=1.0, shrink-to-fit=no' name='viewport' />
    <link rel="icon" href="<?= base_url('assets/') ?>/img/icon.ico" type="image/x-icon"/>
	<!-- <link rel="icon" href="<?= base_url('assets/') ?>/img/BRKS.png" type="image/x-icon"/> -->
	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="http://localhost/BRKS/Admin/" class="logo">
                    <h3 class="text-white pb-2 fw-bold">Software Order Confirmation</h3>
				...
				<div class="sidebar-content">
					<ul class="nav nav-primary">
						<li class="nav-item active">
							<a href="<?= site_url('Admin/') ?>" class="collapsed" aria-expanded="false">
								...
								<ul class="nav nav-collapse">
									...
									<li class="nav-item">
										<a href="<?= site_url('Version/') ?>">
											<span class="sub-item">Product Version</span>
										</a>
									</li>
								</ul>
							</div>
